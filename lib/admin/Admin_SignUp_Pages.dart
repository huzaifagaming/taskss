...
class AdminSignUpPages extends StatefulWidget {
  @override
  _AdminSignUpPagesState createState() => _AdminSignUpPagesState();
}

class _AdminSignUpPagesState extends State<AdminSignUpPages> {
  ...
  Future<void> registerAndSendCode() async {
    ...
    try {
      ...
      // Save code in Firestore for verification
    ...
    try {
      ...
      if (doc.exists && doc['code'] == enteredCode) {
        ...
        if (user != null) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text('User verified and role assigned: $selectedRole')),
          );
        } else {
